...
export const ActionTypes = {
    ...
    GET_CATEGORY_GAMES_ERROR: 'GET_CATEGORY_GAMES_ERROR',
    GET_CATEGORY_GAMES_REQUEST: 'GET_CATEGORY_GAMES_REQUEST',
    GET_CATEGORY_GAMES_SUCCESS: 'GET_CATEGORY_GAMES_SUCCESS',
    // Games
